#!/usr/bin/env python3
"""V71 sealed-holdout entry point retaining the V66 harness-only corrections."""
...
class V71HarnessCommandAdapter(_OriginalCommandAdapter):
    def __init__(self, command: str, timeout: int = 1500):
        super().__init__(command, timeout=timeout)
base.CommandAdapter = V71HarnessCommandAdapter
