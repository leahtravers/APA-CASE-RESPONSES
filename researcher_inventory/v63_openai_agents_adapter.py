#!/usr/bin/env python3
"""V63 contract-version adapter preserving the proven V60 transport/session recovery implementation.
...
prior.base.CONTRACT_VERSION = os.environ.get("CONTRACT_VERSION", "RI-CONTRACT-V63").strip() or "RI-CONTRACT-V63"
RECOVERY_DIR = Path("researcher_inventory/runtime/v63_session_recovery")
