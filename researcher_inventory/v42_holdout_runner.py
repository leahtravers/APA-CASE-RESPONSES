#!/usr/bin/env python3
"""V42 protected sealed-holdout entry point; source/output stay inside existing protected boundary."""
...
class V42CommandAdapter(_OriginalCommandAdapter):
    def __init__(self, command: str, timeout: int = 1500):
        super().__init__(command, timeout=timeout)

base.CommandAdapter = V42CommandAdapter
