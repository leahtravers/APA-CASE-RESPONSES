...
CONTRACT_VERSION = os.environ.get("CONTRACT_VERSION", "RI-CONTRACT-V20")
AGENT_ID_FILE = Path("researcher_inventory/runtime/extractor_agent_id.txt")
CONTRACT_FILE = Path(os.environ.get("RI_CONTRACT_FILE", "researcher_inventory/AGENT_CONTRACT_V20.md"))
